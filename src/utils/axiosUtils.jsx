...
import {UserUrl, GuideUrl, AdminUrl} from '../constants/constants'
...
const GuideAxiosInstant = createAxioxClient(GuideUrl)
GuideAxiosInstant.interceptors.request.use(async (req) =>{
    const modifiedReq = attatToken(req, 'token')
    return modifiedReq
})
